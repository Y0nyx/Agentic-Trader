...
class TestProjectStructure(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.required_files = ["requirements.txt", "setup.py", "README.md"]
    ...
    def test_required_directories_exist(self):
        ...
        for directory in self.required_directories:
            ...
            with self.subTest(directory=directory):
                self.assertTrue(
                    dir_path.exists(), f"Required directory does not exist: {directory}"
                )
                self.assertTrue(
                    dir_path.is_dir(),
    ...
    def test_init_files_exist(self):
        ...
        for directory in self.required_directories:
            ...
            with self.subTest(directory=directory):
                self.assertTrue(
                    init_file.exists(), f"__init__.py does not exist in: {directory}"
                )
                self.assertTrue(
                    init_file.is_file(),
    ...
    def test_required_files_exist(self):
        ...
        for file_name in self.required_files:
            ...
            with self.subTest(file=file_name):
                self.assertTrue(
                    file_path.exists(), f"Required file does not exist: {file_name}"
                )
                self.assertTrue(
                    file_path.is_file(), f"Path exists but is not a file: {file_name}"
                )
    ...
    def test_readme_is_not_empty(self):
        ...
        self.assertIn(
            "Agentic Trader", content, "README.md does not contain project name"
        )
