...
class TestMovingAverageCrossStrategy(unittest.TestCase):
    ...
    def test_strategy_initialization_custom_price_column(self):
        ...
        strategy = MovingAverageCrossStrategy(
            short_window=10, long_window=20, price_column="High"
        )
    ...
    def test_generate_signals_crossover_logic(self):
        ...
        self.assertGreater(
            buy_signals + sell_signals, 0, "Should generate some trading signals"
        )
    ...
    def test_get_strategy_summary_valid_data(self):
        ...
        total_signals = (
            summary["buy_signals"] + summary["sell_signals"] + summary["hold_periods"]
        )
    ...
    def test_different_window_sizes(self):
        ...
        window_combinations = [(5, 10), (10, 20), (20, 50), (3, 7)]
