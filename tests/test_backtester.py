...
class TestBacktester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.declining_signals = pd.DataFrame({
            'Signal': declining_signals
        }, index=self.declining_data.index)
    ...
    def test_run_backtest_no_signals(self):
        ...
        hold_signals = pd.DataFrame({
            'Signal': ['HOLD'] * len(self.sample_data)
...
class TestPerformanceReport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        initial_value = 10000
        values = [initial_value * (1 + i * 0.001) for i in range(30)]  # Small daily growth
    ...
    def test_performance_report_summary(self):
        ...
        required_fields = [
            'initial_capital', 'final_value', 'total_return', 'total_return_pct',
            'annualized_return', 'volatility', 'sharpe_ratio', 'max_drawdown_pct',
    ...
    def test_get_transactions_df_empty(self):
        ...
        report = PerformanceReport(self.portfolio_history, [], self.initial_capital, self.final_value)
    ...
    def test_drawdown_calculation(self):
        ...
        values = [10000, 12000, 11000, 8000, 9000, 11000, 13000]  # Peak of 12000, trough of 8000
        ...
        self.assertAlmostEqual(summary['max_drawdown_pct'], expected_max_drawdown, places=1)
