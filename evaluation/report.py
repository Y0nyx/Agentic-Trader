...
class PerformanceReporter:
    ...
    def _organize_performance_metrics(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "volatility": {
                ...
                "portfolio_volatility_pct": self.metrics.get(
        ...
        return {
            "trade_statistics": {
                ...
                "winning_trades": len(
                    [
                        t
                        for t in self.performance_report.transactions
                        if t.get("pnl", 0) > 0
                    ]
                ),
                "losing_trades": len(
    ...
    def _generate_portfolio_evolution(self) -> Dict[str, Any]:
        ...
        portfolio_copy["Cumulative_Return"] = (
            (portfolio_copy["Total_Value"] / self.performance_report.initial_capital)
            - 1
        ) * 100
    ...
    def _generate_benchmark_comparison(self) -> Dict[str, Any]:
        ...
        benchmark_metrics = {
            ...
            or key in ["alpha", "alpha_pct", "outperformed_benchmark"]
        }
    ...
    def _generate_chart_data(self) -> Dict[str, Any]:
        ...
        portfolio_evolution["Cumulative_Return_Pct"] = (
            (
                portfolio_evolution["Total_Value"]
                / self.performance_report.initial_capital
            )
            - 1
        ) * 100
    ...
    def print_summary_report(
        ...
        if benchmark:
            ...
            lines.append("-" * 30)
            lines.append(
                f"Benchmark Return:     {benchmark.get('benchmark_return_pct', 0):.2f}%"
            )
...
def create_hold_strategy_benchmark(
    data: pd.DataFrame, initial_capital: float = 10000
) -> pd.DataFrame:
    """
